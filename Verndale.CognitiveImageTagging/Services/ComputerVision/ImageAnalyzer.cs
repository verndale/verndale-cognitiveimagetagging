...
namespace Verndale.CognitiveImageTagging.Services.ComputerVision
{
    public class ImageAnalyzer : ComputerVisionBase
    {
        ...
        public ImageAnalyzer(HttpClient client)
            : base(client)
        {
            _textInImageConfidenceLevel = CognitiveImageTaggingConfiguration.Settings.TextInImageConfidenceLevel;
            _captionConfidenceLevel = CognitiveImageTaggingConfiguration.Settings.CaptionConfidenceLevel;
        }
        #endregion
        ...
        private async Task<HttpResponseMessage> GetOperationLocationHeaderForImage(byte[] byteData)
        {
            ...
            queryString["mode"] = CognitiveImageTaggingConfiguration.Settings.TextCheckMode;
        ...
        {
            var visualFeatures = CognitiveImageTaggingConfiguration.Settings.VisualFeatures;
            var details = CognitiveImageTaggingConfiguration.Settings.ImageDetails;
            var detectOrientation = CognitiveImageTaggingConfiguration.Settings.DetectOrientation;
